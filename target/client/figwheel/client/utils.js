...
return (new CustomEvent(event_name,(function (){var obj26660 = ({"detail":data});
return obj26660;
})()));
} else {
...
var f = (function (){var pred__26667 = cljs.core._EQ_;
var expr__26668 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26667.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26668))){
return ((function (pred__26667,expr__26668){
return (function (p1__26661_SHARP_){
return console.warn(p1__26661_SHARP_);
});
;})(pred__26667,expr__26668))
} else {
if(cljs.core.truth_(pred__26667.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26668))){
return ((function (pred__26667,expr__26668){
return (function (p1__26662_SHARP_){
return console.debug(p1__26662_SHARP_);
});
;})(pred__26667,expr__26668))
} else {
if(cljs.core.truth_(pred__26667.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26668))){
return ((function (pred__26667,expr__26668){
return (function (p1__26663_SHARP_){
return console.error(p1__26663_SHARP_);
});
;})(pred__26667,expr__26668))
} else {
return ((function (pred__26667,expr__26668){
return (function (p1__26664_SHARP_){
return console.log(p1__26664_SHARP_);
});
;})(pred__26667,expr__26668))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26671){
...
var eval_fn = cljs.core.get.call(null,map__26672__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26674_SHARP_);
});})(new_def))
);
...
return (function (p__26675){
var vec__26676 = p__26675;
var ky = cljs.core.nth.call(null,vec__26676,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1581396558052
