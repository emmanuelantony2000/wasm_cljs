...
var G__6163 = o;
(G__6163[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__6164__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__6164 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__6165__i = 0, G__6165__a = new Array(arguments.length -  0);
while (G__6165__i < G__6165__a.length) {G__6165__a[G__6165__i] = arguments[G__6165__i + 0]; ++G__6165__i;}
  args = new cljs.core.IndexedSeq(G__6165__a,0,null);
} 
return G__6164__delegate.call(this,args);};
G__6164.cljs$lang$maxFixedArity = 0;
G__6164.cljs$lang$applyTo = (function (arglist__6166){
...
var G__6167 = o;
(G__6167[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__6169__i < G__6169__a.length) {G__6169__a[G__6169__i] = arguments[G__6169__i + 0]; ++G__6169__i;}
  args = new cljs.core.IndexedSeq(G__6169__a,0,null);
} 
...
var G__6172 = props;
var G__6172__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6172,cljs.core.cst$kw$id,id):G__6172);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6172__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__6173){
...
var props = map__6174__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6174__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__6174,map__6174__$1,props,class$){
return (function (c){
...
});})(map__6174,map__6174__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__6176){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6177__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__6177,map__6177__$1,on_write){
return (function (){
...
});})(node_value,map__6177,map__6177__$1,on_write))
);
} else {
...
var G__6180 = jsprops;
(G__6180["defaultValue"] = value);

(G__6180["onChange"] = ((function (G__6180,v,value,on_change){
return (function (p1__6179_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__6179_SHARP_);
});})(G__6180,v,value,on_change))
);
...
var vec__6183 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6183,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6183,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6183,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___6187 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___6187 == null)){
} else {
var key_6188 = temp__5724__auto___6187;
(jsprops["key"] = key_6188);
}
...
var temp__5724__auto___6189 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___6189 == null)){
} else {
var key_6190 = temp__5724__auto___6189;
reagent.impl.template.oset(jsprops,"key",key_6190);
}
...
var G__6191 = reagent.impl.template.__GT_NativeWrapper();
(G__6191["name"] = c);
...
var G__6192 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__6192) : reagent.impl.template.as_element.call(null,G__6192));
} else {
...
var len__4730__auto___6197 = arguments.length;
var i__4731__auto___6198 = (0);
while(true){
if((i__4731__auto___6198 < len__4730__auto___6197)){
args__4736__auto__.push((arguments[i__4731__auto___6198]));

var G__6199 = (i__4731__auto___6198 + (1));
i__4731__auto___6198 = G__6199;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq6195){
var G__6196 = cljs.core.first(seq6195);
var seq6195__$1 = cljs.core.next(seq6195);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6196,seq6195__$1);
});
...
break;
default:
var G__6202 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__6202;
continue;
...
var n__4607__auto___6204 = a.length;
var i_6205 = (0);
while(true){
if((i_6205 < n__4607__auto___6204)){
(a[i_6205] = reagent.impl.template.as_element((a[i_6205])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___6207 = a.length;
var i_6208 = (0);
while(true){
if((i_6208 < n__4607__auto___6207)){
var val_6209 = (a[i_6208]);
if(((cljs.core.vector_QMARK_(val_6209)) && ((reagent.impl.template.key_from_vec(val_6209) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_6208] = reagent.impl.template.as_element(val_6209));
...
var ctx = ({});
var vec__6211 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6211,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6211,(1),null);
...
var G__6214 = (cljs.core.count(argv) - first_child);
switch (G__6214) {
case (0):
...
var G__6215 = comp;
var G__6216 = jsprops;
var G__6217 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__6215,G__6216,G__6217) : reagent.impl.template.global$module$react.createElement.call(null,G__6215,G__6216,G__6217));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__6214){
